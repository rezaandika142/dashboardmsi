...
<body class="h-full">
                  ...
                  <div class="fixed bottom-4 right-4">
                      <button @click="isChatOpen = true" 
                          ...
                          <svg class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M8 10h.01M12 10h.01M16 10h.01M9 16h6M7.05 9.55a5 5 0 119.9 0 4.992 4.992 0 01-2.45 4.28M15 19l-3 3-3-3" />
                        </svg>                        
                      </button>
                  </div>
    ...
    <script>
        async function getContent() {
            try {
                const response = await axios.post(
                    'https://generativelanguage.googleapis.com/v1beta/tunedModels/try-msi-go2swbcfzpss:generateContent?key=AIzaSyATZxxBzP5e129RhkO6BkT8ykFzNkpkfMg', {
                        contents: [{
                            parts: [{
